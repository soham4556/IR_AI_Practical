import java.util.*; 
public class FMeasureAndEMeasure { 
 
    // Method to calculate Precision 
    public static double calculatePrecision(Set<String> retrievedDocs, Set<String> 
relevantDocs) { 
        int truePositives = 0; 
    ...
    public static void main(String[] args) { 
        ...
        Set<String> retrievedDocs = new HashSet<>(Arrays.asList("doc1", "doc2", "doc3", 
"doc4", "doc5")); 
        Set<String> relevantDocs = new HashSet<>(Arrays.asList("doc1", "doc3", "doc6", 
"doc7")); 
